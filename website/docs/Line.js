import { bisect, extent, max, min, range } from "npm:d3-array";
import { axisBottom, axisLeft } from "npm:d3-axis";
import { csv, tsv } from "npm:d3-fetch";
import { format } from "npm:d3-format";
import { scaleLinear, scalePoint, } from "npm:d3-scale";
import { pointer, select, selectAll } from "npm:d3-selection";
//missing mouse exported from d3 selection
import { line } from "npm:d3-shape";
import rough from "npm:roughjs/bundled/rough.esm.js";
import Chart from "./Chart.js";
import { addLegend } from "./utils/addLegend.js";
...
const allDataExtent = (data) => {
  ...
  class Line extends Chart {
    ...
    //     });
        ...
        .domain(extent(data, d => d.date))  // Extent of the data
        .range([0, width])
